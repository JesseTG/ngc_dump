...
The following definitions were used when summarising the levels of sensitivity, specificity, positive predictive value (PPV) and negative predictive value (NPV) for the guideline development group:
