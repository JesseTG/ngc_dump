---
title: "ACR Appropriateness Criteria® chronic wrist pain."
id: 11333
permalink: /:collection/11333
---
...
<table border="1" cellpadding="5" cellspacing="1" summary="Table: Variant 1: Chronic wrist pain. With or without prior injury. Best initial study">
 <thead>
  <tr>
...
<table border="1" cellpadding="5" cellspacing="1" summary="Table: Variant 2: Chronic wrist pain. Routine radiographs normal or nonspecific. Persistent symptoms. Next study">
 <thead>
  <tr>
   <th class="Center" scope="col" valign="top" width="30%">
    Procedure
...
<table border="1" cellpadding="5" cellspacing="1" summary="Table: Variant 3: Chronic wrist pain. Routine radiographs normal or nonspecific. Suspect arthritis. Next study">
 <thead>
  <tr>
   <th class="Center" scope="col" valign="top" width="30%">
    Procedure
...
<table border="1" cellpadding="5" cellspacing="1" summary="Table: Variant 4: Chronic wrist pain. Radiographs normal or show nonspecific arthritis. Exclude infection. Next study">
 <thead>
  <tr>
   <th class="Center" scope="col" valign="top" width="30%">
    Procedure
...
<table border="1" cellpadding="5" cellspacing="1" summary="Table: Variant 5:  Ulnar-sided chronic wrist pain. Radiographs normal or nonspecific. Next study">
 <thead>
  <tr>
   <th class="Center" scope="col" valign="top" width="30%">
    Procedure
...
<table border="1" cellpadding="5" cellspacing="1" summary="Table: Variant 6: Radial-sided chronic wrist pain. Radiographs normal or nonspecific. Next study">
 <thead>
  <tr>
   <th class="Center" scope="col" valign="top" width="30%">
    Procedure
...
<table border="1" cellpadding="5" cellspacing="1" summary="Table: Variant 7: Chronic wrist pain. Radiographs normal or nonspecific. Suspect Kienbock's disease. Next study">
 <thead>
  <tr>
   <th class="Center" scope="col" valign="top" width="30%">
    Procedure
...
<table border="1" cellpadding="5" cellspacing="1" summary="Table: Variant 8: Chronic wrist pain. Kienbock's disease on radiographs. Next study">
 <thead>
  <tr>
   <th class="Center" scope="col" valign="top" width="30%">
    Procedure
...
<table border="1" cellpadding="5" cellspacing="1" summary="Table: Variant 9: Chronic wrist pain. Palpable mass or suspected occult ganglion cyst. Radiographs normal or nonspecific. Next study">
 <thead>
  <tr>
   <th class="Center" scope="col" valign="top" width="30%">
    Procedure
...
<table border="1" cellpadding="5" cellspacing="1" summary="Table: Chronic wrist pain. Suspect occult fracture or stress fracture. Radiographs nondiagnostic. Next study">
 <thead>
  <tr>
   <th class="Center" scope="col" valign="top" width="30%">
    Procedure
 ...
 <tbody>
  ...
  <tr>
   <td valign="top">
    Tc-99m bone scan with SPECT/CT wrist
   </td>
   <td class="Center" valign="top">
    May Be Appropriate
   </td>
...
<table border="1" cellpadding="5" cellspacing="1" summary="Table: Variant 11: Chronic wrist pain. Radiographs show old scaphoid fracture. Evaluate for nonunion, malunion, osteonecrosis, or post-traumatic osteoarthritis. Next study">
 <thead>
  <tr>
   <th class="Center" scope="col" valign="top" width="30%">
    Procedure
...
<table border="1" cellpadding="5" cellspacing="1" summary="Table: Variant 12: Chronic wrist pain. Radiographs normal or nonspecific. Suspect carpal tunnel syndrome">
 <thead>
  <tr>
   <th class="Center" scope="col" valign="top" width="30%">
    Procedure
...
######  MRI 
[ Soft-tissue masses ](/summaries/summary/43873 "Guideline #9665")
...
Of the 71 references cited in the _ACR Appropriateness Criteria ® Chronic Wrist Pain_ document, all of them are categorized as diagnostic references including 3 well-designed studies, 16 good-quality studies, and 23 quality studies that may have design limitations. There are 23 references that may not be useful as primary evidence. There are 6 references that are meta-analysis studies. 
...
## Composition of Group That Authored the Guideline
 ...
 _Panel Members_ : David A. Rubin, MD ( _Principal Author_ ); Catherine C. Roberts, MD ( _Panel Chair_ ); Jenny T. Bencardino, MD ( _Panel Vice-chair_ ); Angela M. Bell, MD; R. Carter Cassidy, MD; Eric Y. Chang, MD; Soterios Gyftopoulos, MD; Darlene F. Metter, MD; William B. Morrison, MD; Naveen Subhas, MD; Siddharth Tambar, MD; Jeffrey D. Towers, MD; Joseph S. Yu, MD; Mark J. Kransdorf, MD ( _Specialty Chair_ )
...
Available from the [American College of Radiology (ACR) Web site](https://acsearch.acr.org/docs/69427/Narrative/ "American College of Radiology \(ACR\) Web site").
...
The following are available:
  ...
  * ACR Appropriateness Criteria® chronic wrist pain. Evidence table. Reston (VA): American College of Radiology; 2017. 25 p. Available from the [ACR Web site](https://acsearch.acr.org/docs/69427/EvidenceTable/ "ACR Web site"). 
  * ACR Appropriateness Criteria® chronic wrist pain. Literature search summary. Reston (VA): American College of Radiology; 2017. 2 p. Available from the [ACR Web site](https://acsearch.acr.org/docs/69427/LitSearch/ "ACR Web site"). 
