---
title: "Pediatric hydrocephalus: systematic literature review and evidence-based guidelines. Part 7: antibiotic-impregnated shunt systems versus conventional shunts in children: a systematic review and meta-analysis."
id: 10757
permalink: /:collection/10757
---
...
- Klimo P Jr, Thompson CJ, Baird LC, Flannery AM. Pediatric hydrocephalus: systematic literature review and evidence-based guidelines. Part 7: Antibiotic-impregnated shunt systems versus conventional shunts in children: a systematic review and meta-analysis. J Neurosurg Pediatr. 2014 Nov;14 Suppl 1:53-9. [56 references] [ PubMed ](http://www.ncbi.nlm.nih.gov/entrez/query.fcgi?cmd=Retrieve&db=pubmed&dopt=Abstract&list_uids=25988783)
...
Antibiotic-impregnated shunt (AIS) tubing may be associated with a lower risk of shunt infection compared with conventional silicone hardware and thus is an option for children who require placement of a shunt. **Strength of Recommendation: Level III, unclear degree of clinical certainty** . 
...
To answer the following question: Are antibiotic-impregnated shunts (AISs) superior to standard shunts (SSs) at reducing the risk of shunt infection in pediatric patients with hydrocephalus?
...
## Interventions and Practices Considered
  ...
  1. Antibiotic-impregnated shunt (AIS) systems 
  2. Conventional shunt systems 
...
Shunt infection rate (development of signs and symptoms of a shunt malfunction or an infection with an organism cultured from cerebrospinal fluid (CSF), the shunt apparatus, purulence from the shunt wound[s], or abdominal fluid/pseudocyst)
...
The Task Force searched the US National Library of Medicine PubMed/MEDLINE database and the Cochrane Database of Systematic Reviews for the period January 1966 through March 2012 using the following medical subject headings (MeSH): ("cerebrospinal fluid shunts" OR ("cerebrospinal fluid" AND (shunt* OR catheter*)) OR "shunt system") AND ("antibiotic-impregnated" OR (antibiotic AND impregnated)) AND infection.

**Search Strategy**

The Task Force members reviewed the titles and abstracts of the papers they retrieved with attention to those titles addressing the rate of shunt infection in patients treated with antibiotic-impregnated shunts (AISs) compared with those treated with standard shunts (SSs). Uncontrolled studies were excluded, as were studies that evaluated antimicrobial shunts unavailable in the US market. In all papers, the Task Force required that the authors state that the only variable that changed was the type of shunt implanted; all other aspects of the surgery and technique needed to remain unchanged.

**Search Results**

The search returned 41 articles; another 3 articles were found from an examination of the articles' bibliographies (see Figure 1 in the original guideline document). Nineteen full-length papers were reviewed, 13 of which were rejected for the following reasons: studies enrolled either adults only or enrolled mixed populations, but separate results for children were not provided, or studies contained patient data that had also been reported in separate publications. In fact, 1 group of researchers published no less than 9 papers on AISs that included patients from overlapping time periods. Therefore, 6 articles satisfied inclusion for this systematic review and meta-analysis (see Table 1 in the original guideline document).

## Number of Source Documents



Six articles satisfied inclusion criteria for this systematic review and meta-analysis (all Class III cohort studies). Also see Fig. 1 in the original guideline document for the flowchart showing the process involved in identifying relevant literature.
...
For each study, the Task Force identified the number of infections resulting from implantation of standard shunts (SSs) and antibiotic-impregnated shunts (AISs) and then computed the risk of an infection associated with AISs relative to that associated with SSs, yielding a risk ratio (RR). An RR less than 1 is indicative of protection against infection for the AIS. The overall RR was computed using the method of DerSimonian and Laird.

The Task Force conducted a random-effects meta-analysis of the selected studies. A random-effects model—as opposed to a fixed-effects model—does not assume that the measure of association (that is, RR) is uniform across strata (that is, among studies) and, consequently, yields a more conservative estimate of the effect. The Task Force assessed heterogeneity by way of the chi-square test of heterogeneity and the I2 statistic, in which the former returns a chi-square distributed test statistic and corresponding _p_ value and the latter returns a value bound between 0% and 100%, with higher values denoting increasing heterogeneity. The Task Force regarded a chi-square test of heterogeneity _p_ value less than alpha=0.10 and an I 2 value in the range of 30% to 60% as suggestive of moderate heterogeneity. An examination of publication bias was not conducted since the number of studies included in this analysis was not large enough to provide adequate power (i.e., fewer than 10 studies).
...
## Composition of Group That Authored the Guideline
 ...
 _Authors_ : Paul Klimo Jr., MD, MPH, Semmes-Murphey Neurologic & Spine Institute, Department of Neurosurgery, University of Tennessee Health Science Center, Le Bonheur Children's Hospital, Memphis, Tennessee; Clinton J. Thompson, PhD, School of Public Health and Health Services, The George Washington University, Washington, DC; Lissa C. Baird, MD, School of Public Health and Health Services, The George Washington University, Washington, DC; Ann Marie Flannery, MD, Department of Neurological Surgery, Saint Louis University, St. Louis, Missouri
...
Available from the [Journal of Neurosurgery: Pediatrics Web site](http://thejns.org/doi/pdf/10.3171/2014.7.PEDS14327 "Journal of Neurosurgery: Pediatrics Web site").
